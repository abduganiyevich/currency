    ...
    <div className="header">
       <div className="container">
        ...
        <div className="header-register">
            ...
            <div className='title'>
                <h1>Trusted Global Currency Converter & Money Transfers</h1>
